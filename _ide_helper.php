 ...
 * Generated for Laravel 6.9.0 on 2020-01-08 07:32:08.
 *
...
namespace Modules\Restaurants\Entities {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Food[]|Food create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Food[]|Food make($attributes = [])
    */
    class FoodFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace Modules\Restaurants\Entities {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Restaurant[]|Restaurant create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Restaurant[]|Restaurant make($attributes = [])
    */
    class RestaurantFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
